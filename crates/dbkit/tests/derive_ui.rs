...
fn main() -> ui_test::color_eyre::Result<()> {
    ...
    config.filter_files = vec![
        ...
        "pass_mutation_exists_subquery.rs".into(),
        "pass_row_value_in_api.rs".into(),
        "fail_row_value_in_type_mismatch.rs".into(),
        "fail_row_value_in_tuple_arity.rs".into(),
        ...
        "fail_string_extraction_argument_types.rs".into(),
        "fail_string_length_non_text.rs".into(),
        "fail_string_search_non_text.rs".into(),
        "fail_string_transformation_argument_types.rs".into(),
        "fail_string_composition_argument_types.rs".into(),
        "fail_string_function_aliases.rs".into(),
        "pass_regex_inspection_api.rs".into(),
        "fail_regex_inspection_argument_types.rs".into(),
        "fail_regex_inspection_aliases.rs".into(),
        "pass_regex_transform_api.rs".into(),
        "fail_regex_transform_argument_types.rs".into(),
        "fail_regex_transform_aliases.rs".into(),
        "fail_regex_transform_flags_required.rs".into(),
        "pass_unicode_character_func_api.rs".into(),
